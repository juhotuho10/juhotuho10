...
<div style="display: flex; flex-wrap: nowrap; gap: 10px; align-items: center; overflow-x: auto; margin-bottom: 20px;">
  ...
  </div><div style="text-align: center; width: 110px;">
...
<div style="display: flex; flex-wrap: nowrap; gap: 10px; align-items: center; overflow-x: auto; margin-bottom: 20px;">
  ...
  </div><div style="text-align: center; width: 150px;">
  ...
  </div><div style="text-align: center; width: 80px;">
